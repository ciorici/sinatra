...
if ( ! class_exists( 'Prisma_Core_Customizer_Control_Button' ) ) :
	 ...
	 * Prisma Core Customizer custom background control class.
	 */
	class Prisma_Core_Customizer_Control_Button extends Prisma_Core_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'prisma-core-button';
		...
		protected function content_template() {
			?>
			<div class="prisma-core-button-wrapper prisma-core-control-wrapper">
			...
			<# if ( data.description ) { #>
				<div class="description customize-control-description prisma-core-field">{{{ data.description }}}</div>
			<# } #>
