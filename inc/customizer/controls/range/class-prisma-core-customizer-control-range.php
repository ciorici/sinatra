...
if ( ! class_exists( 'Prisma_Core_Customizer_Control_Range' ) ) :
	/**
	 * Prisma Core Customizer custom heading control class.
	 */
	class Prisma_Core_Customizer_Control_Range extends Prisma_Core_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="prisma-core-range-wrapper prisma-core-control-wrapper">
				...
				<div class="prisma-core-control-wrap" data-unit="{{ data.value['unit'] }}">
