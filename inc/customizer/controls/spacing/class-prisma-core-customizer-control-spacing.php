<?php
/**
 * Prisma Core Customizer custom spacing control class.
 *
 * @package     Prisma Core
...
if ( ! class_exists( 'Prisma_Core_Customizer_Control_Spacing' ) ) :
	/**
	 * Prisma Core Customizer custom select control class.
	 */
	class Prisma_Core_Customizer_Control_Spacing extends Prisma_Core_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'prisma-core-spacing';
		...
		public function to_json() {
			...
			$this->json['title']   = esc_html__( 'Link values', 'prisma-core' );
		...
		protected function content_template() {
			?>
			<div class="prisma-core-control-wrapper prisma-core-spacing-wrapper<# if ( data.responsive ) { #> prisma-core-control-responsive <# } #>">
				...
				</div><!-- END .prisma-core-control-wrap -->
