<?php
/**
 * Prisma Core Customizer custom control class. To be extended in other controls.
 *
 * @package     Prisma Core
...
if ( ! class_exists( 'Prisma_Core_Customizer_Control' ) ) :
	/**
	 * Prisma Core Customizer custom control class. To be extended in other controls.
	 */
	class Prisma_Core_Customizer_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			if ( isset( $args['responsive'] ) && true === $args['responsive'] ) {
				$this->responsive = apply_filters(
					'prisma_core_customizer_responsive_breakpoints',
					array(
						'desktop' => array(
		...
		protected function responsive_devices() {
			?>
			<ul class="prisma-core-responsive-switchers">
		...
		public static function template_units() {
			?>
			<script type="text/template" id="tmpl-prisma-core-control-unit">

				<# if ( _.isObject( data.unit ) ) { #>

					<div class="prisma-core-control-unit">
