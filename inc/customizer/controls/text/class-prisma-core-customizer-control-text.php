<?php
/**
 * Prisma Core Customizer custom text control class.
 *
 * @package     Prisma Core
...
if ( ! class_exists( 'Prisma_Core_Customizer_Control_Text' ) ) :
	/**
	 * Prisma Core Customizer custom select control class.
	 */
	class Prisma_Core_Customizer_Control_Text extends Prisma_Core_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="prisma-core-control-wrapper prisma-core-text-wrapper">
