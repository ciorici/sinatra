...
if ( ! class_exists( 'Prisma_Core_Customizer_Control_Sortable' ) ) :
	/**
	 * Prisma Core Customizer custom select control class.
	 */
	class Prisma_Core_Customizer_Control_Sortable extends Prisma_Core_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'prisma-core-sortable';
		...
		protected function content_template() {
			?>
			<div class="prisma-core-control-wrapper prisma-core-sortable-wrapper">
				...
				<ul class="prisma-core-sortable-control">
					<# for ( key in data.value ) { #>
						<li class="prisma-core-sortable-item<# if ( _.has( data.value, key) && ! data.value[ key ] || ! _.has( data.value, key ) && _.has( data.default, key ) && ! data.default[ key ] ) { #> invisible<# } #>" data-value="{{ key }}">
							<# if ( data.sortable ) { #>
