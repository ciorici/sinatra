...
if ( ! class_exists( 'Prisma_Core_Customizer_Control_Select' ) ) :
	/**
	 * Prisma Core Customizer custom select control class.
	 */
	class Prisma_Core_Customizer_Control_Select extends Prisma_Core_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'prisma-core-select';
		...
		protected function content_template() {
			?>
			<div class="prisma-core-control-wrapper prisma-core-select-wrapper">
				...
				<label>
					...
					<select class="prisma-core-select-control" {{{ data.link }}}{{{ data.multiple }}}>
