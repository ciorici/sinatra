<?php
/**
 * Prisma Core Customizer custom typography control class.
 *
 * @package     Prisma Core
...
if ( ! class_exists( 'Prisma_Core_Customizer_Control_Typography' ) ) :
	/**
	 * Prisma Core Customizer custom typography control class.
	 */
	class Prisma_Core_Customizer_Control_Typography extends Prisma_Core_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'prisma-core-typography';
		...
		public function enqueue() {
			...
			wp_localize_script(
				$this->type . '-js',
				'prisma_core_typography_vars',
				array(
					'fonts'   => prisma_core()->fonts->get_fonts(),
					'default' => prisma_core()->fonts->get_default_system_font(),
				)
			);
			 ...
			 */
			wp_enqueue_style(
				'prisma-core-select2-style',
				PRISMA_CORE_THEME_URI . '/inc/admin/assets/css/select2' . $prisma_core_suffix . '.css',
				false,
			 ...
			 */
			wp_enqueue_script(
				'prisma-core-select2-js',
				PRISMA_CORE_THEME_URI . '/inc/admin/assets/js/libs/select2' . $prisma_core_suffix . '.js',
				array( 'jquery' ),
				PRISMA_CORE_THEME_VERSION,
				true
			);
		...
		public function to_json() {
			...
			$this->json['l10n'] = array(
				'advanced'        => esc_html__( 'Advanced', 'prisma-core' ),
				'font-family'     => esc_html__( 'Font Family', 'prisma-core' ),
				'font-subsets'    => esc_html__( 'Languages', 'prisma-core' ),
				'font-weight'     => esc_html__( 'Weight', 'prisma-core' ),
				'font-size'       => esc_html__( 'Size', 'prisma-core' ),
				'font-style'      => esc_html__( 'Style', 'prisma-core' ),
				'text-transform'  => esc_html__( 'Transform', 'prisma-core' ),
				'text-decoration' => esc_html__( 'Decoration', 'prisma-core' ),
				'line-height'     => esc_html__( 'Line Height', 'prisma-core' ),
				'letter-spacing'  => esc_html__( 'Letter Spacing', 'prisma-core' ),
				'inherit'         => esc_html__( 'Inherit', 'prisma-core' ),
				'default'         => esc_html__( 'Default System Font', 'prisma-core' ),
				'weights'         => array(
					'inherit'   => esc_html__( 'Inherit', 'prisma-core' ),
					'100'       => esc_html__( 'Thin 100', 'prisma-core' ),
					'100italic' => esc_html__( 'Thin 100 Italic', 'prisma-core' ),
					'200'       => esc_html__( 'Extra-Thin 200', 'prisma-core' ),
					'200italic' => esc_html__( 'Extra-Thin 200 Italic', 'prisma-core' ),
					'300'       => esc_html__( 'Light 300', 'prisma-core' ),
					'300italic' => esc_html__( 'Light 300 Italic', 'prisma-core' ),
					'400'       => esc_html__( 'Normal 400', 'prisma-core' ),
					'400italic' => esc_html__( 'Normal 400 Italic', 'prisma-core' ),
					'500'       => esc_html__( 'Medium 500', 'prisma-core' ),
					'500italic' => esc_html__( 'Medium 500 Italic', 'prisma-core' ),
					'600'       => esc_html__( 'Semi-Bold 600', 'prisma-core' ),
					'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'prisma-core' ),
					'700'       => esc_html__( 'Bold 700', 'prisma-core' ),
					'700italic' => esc_html__( 'Bold 700 Italic', 'prisma-core' ),
					'800'       => esc_html__( 'Extra-Bold 800', 'prisma-core' ),
					'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'prisma-core' ),
					'900'       => esc_html__( 'Black 900', 'prisma-core' ),
					'900italic' => esc_html__( 'Black 900 Italic', 'prisma-core' ),
				),
				'subsets'         => prisma_core()->fonts->get_google_font_subsets(),
				'transforms'      => array(
					'inherit'    => esc_html__( 'Inherit', 'prisma-core' ),
					'uppercase'  => esc_html__( 'Uppercase', 'prisma-core' ),
					'lowercase'  => esc_html__( 'Lowercase', 'prisma-core' ),
					'capitalize' => esc_html__( 'Capitalize', 'prisma-core' ),
					'none'       => esc_html__( 'None', 'prisma-core' ),
				),
				'decorations'     => array(
					'inherit'      => esc_html__( 'Inherit', 'prisma-core' ),
					'underline'    => esc_html__( 'Underline', 'prisma-core' ),
					'overline'     => esc_html__( 'Overline', 'prisma-core' ),
					'line-through' => esc_html__( 'Line Through', 'prisma-core' ),
					'none'         => esc_html__( 'None', 'prisma-core' ),
				),
				'styles'          => array(
					'inherit' => esc_html__( 'Inherit', 'prisma-core' ),
					'normal'  => esc_html__( 'Normal', 'prisma-core' ),
					'italic'  => esc_html__( 'Italic', 'prisma-core' ),
					'oblique' => esc_html__( 'Oblique', 'prisma-core' ),
				),
			);
			...
			$this->json['responsive'] = array(
				'desktop' => array(
					'title' => esc_html__( 'Desktop', 'prisma-core' ),
					'icon'  => 'dashicons dashicons-desktop',
				),
				'tablet'  => array(
					'title' => esc_html__( 'Tablet', 'prisma-core' ),
					'icon'  => 'dashicons dashicons-tablet',
				),
				'mobile'  => array(
					'title' => esc_html__( 'Mobile', 'prisma-core' ),
		...
		protected function content_template() {
			?>
			<div class="prisma-core-typography-wrapper prisma-core-popup-options prisma-core-control-wrapper">

				<div class="prisma-core-typography-heading">
					<# if ( data.label ) { #>
				...
				<div class="popup-content hidden">
					...
					<# if ( 'font-family' in data.display ) { #>
						<!-- Font Family -->
						<div class="prisma-core-select-wrapper prisma-core-typography-font-family">
					...
					<# if ( 'font-subsets' in data.display ) { #>
						<!-- Font subsets -->
						<div class="prisma-core-select-wrapper prisma-core-typography-font-subsets">
					...
					<# if ( 'font-size' in data.display ) { #>
						<!-- Font Size -->
						<div class="prisma-core-range-wrapper prisma-core-typography-font-size prisma-core-control-responsive" data-option-id="font-size">
							<label for="font-size-{{ data.id }}">
								<span>{{{ data.l10n['font-size'] }}}</span>
								<?php $this->responsive_devices(); ?>
							</label>

							<div class="prisma-core-control-wrap" data-unit="{{ data.value['font-size-unit'] }}">
								...
								<# } ); #>
							</div><!-- .prisma-core-control-wrap -->
						</div><!-- .prisma-core-range-wrapper -->
					<# } #>

					<# if ( 'font-weight' in data.display ) { #>
						<!-- Font Weight -->
						<div class="prisma-core-select-wrapper prisma-core-typography-font-weight">
					...
					<# if ( 'font-style' in data.display ) { #>
						<!-- Font Style -->
						<div class="prisma-core-select-wrapper prisma-core-typography-font-style">
					...
					<# if ( 'text-transform' in data.display ) { #>
						<!-- Text Transform -->
						<div class="prisma-core-select-wrapper prisma-core-typography-text-transform">
					...
					<# if ( 'text-decoration' in data.display ) { #>
						<!-- Text Transform -->
						<div class="prisma-core-select-wrapper prisma-core-typography-text-decoration">
					...
					<# if ( 'line-height' in data.display ) { #>
						<!-- Line Height -->
						<div class="prisma-core-range-wrapper prisma-core-typography-line-height prisma-core-control-responsive" data-option-id="line-height">
							<label for="line-height-{{ data.id }}">
								<span>{{{ data.l10n['line-height'] }}}</span>
								<?php $this->responsive_devices(); ?>
							</label>

							<div class="prisma-core-control-wrap" data-unit="{{ data.value['line-height-unit'] }}">
								<# _.each( data.responsive, function( settings, device ){ #>
					...
					<# if ( 'letter-spacing' in data.display ) { #>
						<!-- Letter Spacing -->
						<div class="prisma-core-range-wrapper prisma-core-typography-letter-spacing prisma-core-control-responsive" data-option-id="letter-spacing">
							<label for="letter-spacing-{{ data.id }}">
								<span>{{{ data.l10n['letter-spacing'] }}}</span>
							</label>

							<div class="prisma-core-control-wrap" data-unit="{{ data.value['letter-spacing-unit'] }}">
								<input 
									type="range" 
									{{{ data.inputAttrs }}} 
					...
					<# } #>
				</div><!-- .prisma-core-typography-advanced -->
