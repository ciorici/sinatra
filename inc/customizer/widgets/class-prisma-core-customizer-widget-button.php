...
if ( ! class_exists( 'Prisma_Core_Customizer_Widget_Button' ) ) :

	/**
	 * Prisma Core Customizer widget class
	 */
	class Prisma_Core_Customizer_Widget_Button extends Prisma_Core_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$args['values']['text']       = wp_kses( $args['values']['text'], prisma_core_get_allowed_html_tags() );
			...
			$this->name        = __( 'Button', 'prisma-core' );
			$this->description = __( 'A button with custom link.', 'prisma-core' );
		...
		public function form() {
			...
			<!-- Text -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-text"><?php esc_html_e( 'Text', 'prisma-core' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button Text', 'prisma-core' ); ?>"/>
			</p>

			<!-- URL -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-url"><?php esc_html_e( 'URL', 'prisma-core' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button URL', 'prisma-core' ); ?>" />
			</p>

			<!-- Target -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-target"><?php esc_html_e( 'Open link in', 'prisma-core' ); ?>:</label>
				<span class="buttonset">
					<input 
						...
						<label 
							...
							<?php esc_html_e( 'Same Tab', 'prisma-core' ); ?>
						</label>
					</input>
					<input 
						class="switch-input screen-reader-text" 
						...
						<label 
							...
							<?php esc_html_e( 'New Tab', 'prisma-core' ); ?>
						</label>
					</input>
				</span>
			</p>
			...
			<?php if ( ! empty( $this->styles ) ) { ?>
				<!-- Styles -->
				<p class="prisma-core-widget-button-style">
			...
			<!-- Class -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-class"><?php esc_html_e( 'Additional class', 'prisma-core' ); ?>:</label>
				<input 
					type="text" 
