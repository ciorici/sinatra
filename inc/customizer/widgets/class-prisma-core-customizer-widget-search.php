...
if ( ! class_exists( 'Prisma_Core_Customizer_Widget_Search' ) ) :

	/**
	 * Prisma Core Customizer widget class
	 */
	class Prisma_Core_Customizer_Widget_Search extends Prisma_Core_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Search', 'prisma-core' );
			$this->description = __( 'A search form for your site.', 'prisma-core' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="prisma-core-widget-search-style">
