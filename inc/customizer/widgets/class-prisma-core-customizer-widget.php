...
if ( ! class_exists( 'Prisma_Core_Customizer_Widget' ) ) :

	/**
	 * Prisma Core Customizer widget class
	 */
	class Prisma_Core_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->option_name = 'prisma_core_customizer_widget_' . $this->id_base;
		...
		public function template() {
			?>
			<div class="widget" id="prisma_core_widget-<?php echo esc_attr( $this->id_base ); ?>-<?php echo esc_attr( $this->number ); ?>" data-widget-base="<?php echo esc_attr( $this->id_base ); ?>" data-widget-type="<?php echo esc_attr( $this->type ); ?>">

				<div class="widget-top">		

					<div class="widget-title-action">
						<button type="button" class="widget-action" aria-expanded="false">
							<span class="screen-reader-text"><?php esc_html_e( 'Edit widget:', 'prisma-core' ); ?> <?php echo esc_html( $this->name ); ?></span>
					...
					<div class="form">
						<div class="widget-content">
							...
							<?php if ( isset( $this->locations ) && is_array( $this->locations ) && ! empty( $this->locations ) ) { ?>
								...
								<p>
									<label for="prisma-core-widget-location"><?php esc_html_e( 'Widget Location', 'prisma-core' ); ?></label>
							...
							<?php if ( isset( $this->visibility ) && is_array( $this->visibility ) && ! empty( $this->visibility ) ) { ?>
								...
								<p>
									<label for="prisma-core-widget-visibility"><?php esc_html_e( 'Visibility', 'prisma-core' ); ?></label>
						...
						<div class="widget-control-actions">
							<div class="alignleft">
								<button type="button" class="button-link button-link-delete widget-control-remove"><?php esc_html_e( 'Delete', 'prisma-core' ); ?></button>
								<span class="widget-control-close-wrapper">
									|
									<button type="button" class="button-link widget-control-close"><?php esc_html_e( 'Done', 'prisma-core' ); ?></button>
								</span>
							</div>
