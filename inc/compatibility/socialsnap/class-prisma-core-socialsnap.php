...
if ( ! class_exists( 'Prisma_Core_SocialSnap' ) ) :
	/**
	 * Social Snap compatibility class.
	 */
	class Prisma_Core_SocialSnap {
		...
		public function __construct() {
			...
			add_filter( 'prisma_core_default_option_values', array( $this, 'default_customizer_values' ), 20 );

			// Remove Social Snap Lite from recommended plugins.
			add_filter( 'prisma_core_recommended_plugins', array( $this, 'update_recommended_plugins' ) );

			// Include helper functions.
			require PRISMA_CORE_THEME_PATH . '/inc/compatibility/socialsnap/socialsnap-functions.php'; // phpcs:ignore
		}
		...
		public function register_options( $options ) {
			...
			$options['setting']['prisma_core_single_post_meta_elements']['control']['choices']['shares'] = esc_html__( 'Shares', 'prisma-core' );

			$options['setting']['prisma_core_blog_entry_meta_elements']['control']['choices']['shares'] = esc_html__( 'Shares', 'prisma-core' );
		...
		public function default_customizer_values( $defaults ) {
			...
			$defaults['prisma_core_single_post_meta_elements']['shares'] = false;
			$defaults['prisma_core_blog_entry_meta_elements']['shares']  = false;
