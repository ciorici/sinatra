...
Community-maintained fork of the original Sinatra theme. Includes security fixes, PHP 8.2+ compatibility, WordPress 6.9+ support, and updated WooCommerce templates.

[Download Latest Release](https://github.com/wpzoom/prisma-core/releases) &nbsp;&middot;&nbsp; [View on WordPress.org](https://wordpress.org/themes/prisma-core/)

![Prisma Core Theme Screenshot](screenshot.jpg)

**Contributors:** [ciorici](https://github.com/ciorici)  
...
Prisma Core WordPress Theme, Copyright 2025 WPZOOM
